...
def generate_basename(bioproject,sampling):
    """
    Args:
        stressor = stressor to be held out for testing
        sampling = Up, Down, or none
    """
    basename = bioproject+"_Test_"+sampling+"_HeatOnly"
...
def main():
    ...
    X_train, y_train, X_test, y_test = split_prep_bioproject(bioproject,log_tpm,"up")
    ...
    base = generate_basename(bioproject,sampling)
